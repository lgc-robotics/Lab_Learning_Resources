...
4.学习机器人学逆解解析解相关内容 <br>
5.完成我们机械臂解析解逆解的手写推导 <br>
6.完成机械臂的解析解逆解的代码撰写 <br>
7.结合正解测试10000组逆解的成功率进行可视化 <br>
8.机器人学继续往后学数值解法并深度理解雅可比 <br>
9.学习非线性最小二乘梯度下降法和高斯牛顿法 <br>
10.结合学习内容完成机械臂高斯牛顿法逆解的完整推导及过程梳理 <br>
11.完成机械臂高斯牛顿逆解代码撰写 <br>
12.完成LM算法机械臂逆解代码撰写 <br>
13.可视化验证和上机验证逆解 <br>
14.学习pybullet <br>
15.根据urdf文件和小车模型并熟练pybullet三维建模后进行各项测试 <br>
16.根据林老师布置的任务进行科研 <br>
