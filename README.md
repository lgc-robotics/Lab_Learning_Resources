...
3. 开源机器人物理引擎Pybullet以及它的帮助文档：<br>
https://github.com/bulletphysics/bullet3 <br>
https://pybullet.org/Bullet/BulletFull/ <br>

## 实验室机器人课程：<br>
下述内容，能否整理出对应的代码、书籍、PDF、网址等具体的资料，方便后续研究生快速上手？ <br>
下面的16节内容，可以合并为10节左右！ <br>

第1节.在b站或者其他渠道找课，购买书籍或者pdf电子书辅助学习 <br>
第2节.学完正运动学后完成我们自己机械臂正运动学的推导 <br>
第3节.学习示教器的使用，并通过示教器进行验证正解是否正确 <br>
第4节.学习机器人学逆解解析解相关内容 <br>
第5节.完成我们机械臂解析解逆解的手写推导 <br>
第6节.完成机械臂的解析解逆解的代码撰写 <br>
第7节.结合正解测试10000组逆解的成功率进行可视化 <br>
第8节.机器人学继续往后学数值解法并深度理解雅可比 <br>
     雅可比，有没网址？<br>
第9节.学习非线性最小二乘梯度下降法和高斯牛顿法 <br>
第10节.结合学习内容完成机械臂高斯牛顿法逆解的完整推导及过程梳理 <br>
第11节.完成机械臂高斯牛顿逆解代码撰写 <br>
第12节.完成LM算法机械臂逆解代码撰写 <br>
第13节.可视化验证和上机验证逆解 <br>
第14节.学习pybullet <br>
第15节.根据urdf文件和小车模型并熟练pybullet三维建模后进行各项测试 <br>
第16节.根据林老师布置的任务进行科研 <br>
