# 实验室学习资源
研究生、本科生学习资源，涵盖书籍、论文、博客、视频、典型案例等资料。<br>
...
https://zh-v2.d2l.ai/index.html  <br>
2. 佛吉尼亚大学的深度学习课程，深入浅出，特别推荐。适合于有一定基础的研究生：<br>
...
## 机器人学
1. 蔡自兴，《机器人学》，第四版 <br>
2. Petercorke是机器人领域的大咖，维护着一个开源工具箱和文档。该工具箱支持DH/MDH模型、运动学正解、运动学逆解、可视化、避障路径规划等功能：<br>
https://github.com/petercorke/robotics-toolbox-python <br>
https://petercorke.github.io/robotics-toolbox-python/ <br>
3. URDF的权威文档：<br>
https://wiki.ros.org/urdf/Tutorials <br>
4. 开源机器人物理引擎Pybullet以及它的帮助文档：<br>
https://github.com/bulletphysics/bullet3 <br>
https://pybullet.org/Bullet/BulletFull/ <br>

## 实验室机器人课程：<br>
第1节. 学习机器人正运动学 <br>
目标：手推实验室机械臂正运动学模型，编写正解代码 <br>
代码：见robot_lesson

第2节. 学习实验室机械臂的示教器和API <br>
目标：熟练掌握示教器的使用，并通过示教器进行验证正解是否正确 <br>
示教器网址：http://192.168.1.18/#/login <br>
API网址：https://develop.realman-robotics.com/robot/summarize/ <br>

第3节. 旋转矩阵与RPY角的转换关系 <br>
目标：熟练掌握旋转矩阵与PRY角的转换关系；编写代码可视化机器人，以及可视化末端执行器的位姿。 <br>

第4节. 学习机器人逆运动学 <br>
目标：用"解析法"手推实验室机械臂的逆解；编写逆解代码，结合正解测试10000组逆解的成功率；可视化机器人位姿，观察逆解质量 <br>
代码：见robot_lesson
...
第7节. 基于高斯牛顿法的机械臂逆解数值解法 <br>
目标：掌握完整推导及过程梳理；编写代码，结合正解测试10000组逆解的成功率；可视化机器人位姿，观察逆解质量 <br>
代码：见robot_lesson

第8节. 基于LM的机械臂逆解数值解法  <br>
目标：掌握完整推导及过程梳理；编写代码，结合正解测试10000组逆解的成功率；可视化机器人位姿，观察逆解质量 <br>
代码：见robot_lesson

第9节. 基于罚函数-高斯牛顿法的冗余采摘机器人逆解方法 <br>
论文：林桂潮,曾文勇,徐垚,等. 基于罚函数-高斯牛顿法的冗余采摘机器人逆解方法 [J]. 农业机械学报, 2025, 56 (9): 355-362. <br>
目标：复现论文 <br>
代码：见robot_lesson

第10节. 上机验证上述逆解方法，给出测试报告 <br>

第11节. 学习pybullet <br>
PDF：见robot_lesson

第12节. 掌握实验室机械臂URDF模型，应用pybullet控制机械臂运动 <br>
代码：见robot_lesson
