...
目标：熟练掌握旋转矩阵与PRY角的转换关系；编写代码可视化机器人，以及可视化末端执行器的位姿（重点是姿态）。 <br>

第4节. 学习机器人逆运动学 <br>
目标：用"解析法"手推实验室机械臂的逆解；编写逆解代码，结合正解测试10000组逆解的成功率；可视化机器人位姿 <br>
代码：见robot_lesson
...
目标：掌握完整推导及过程梳理；编写代码，结合正解测试10000组逆解的成功率；可视化机器人位姿 <br>
代码：见robot_lesson

第8节. 基于LM的机械臂逆解逆解数值解法  <br>
目标：掌握完整推导及过程梳理；编写代码，结合正解测试10000组逆解的成功率；可视化机器人位姿 <br>
代码：见robot_lesson
